...
const dream: Dream = {
  ...
  analysis_json: { version: 1, summary: "", core_interpretation: "", themes: [], symbols: [{ name: "Flood Water", context: "Inside the house", possible_meanings: [], confidence: "High" as any }], characters: [{ name: "Grandfather", role: "guide" }], locations: [{ name: "Childhood Home", significance: "Recurring family setting" }], emotions: [{ emotion: "Fear", intensity: "High" as any, context: "Before entering" }], transformations: [], tensions: [], alternative_readings: [], reflection_questions: [], uncertainty_notes: [] },
};
...
assert.equal(entities.find(item => item.entity_type === "emotion")?.confidence, "high");
